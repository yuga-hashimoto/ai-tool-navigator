                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex flex-col items-end gap-2">
                          ...
                          <AffiliateLinkButton
                            ...
                            className="group inline-flex items-center text-xs font-semibold text-green-600 hover:text-green-500 dark:text-green-400"
                          >
                            {copy.visitLabel}
                            <ExternalLink className="ml-1 h-3 w-3 transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5" />
                          </AffiliateLinkButton>
                        </div>
                      </td>
                    </tr>
