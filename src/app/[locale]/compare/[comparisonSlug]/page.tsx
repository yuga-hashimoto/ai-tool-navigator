                      ...
                      <td className="px-6 py-5">
                        <div className="flex flex-wrap items-center justify-end gap-4">
                          ...
                          <AffiliateLinkButton
                            ...
                            className="inline-flex items-center rounded-full bg-green-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-green-500 dark:bg-green-600 dark:text-white dark:hover:bg-green-500"
                          >
                            {copy.visit}
