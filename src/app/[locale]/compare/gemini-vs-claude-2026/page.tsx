...
export async function generateMetadata({
  ...
  return {
    ...
    description: isJapanese
      ? "この固定比較記事は編集レビュー中です。最新の比較は比較ハブまたはカテゴリLPから確認してください。"
      : "This fixed comparison page is under editorial review. Use the comparison hub or category hubs for current recommendations.",
    robots: {
      index: false,
      follow: false,
    },
...
export default async function ComparePage({
  ...
  const copy = isJapanese
    ? {
        ...
        body:
          "将来時点の断定表現や固定ベンチマークの扱いを見直しているため、この固定比較記事は主要導線とインデックスから外しています。比較ハブまたはコーディングカテゴリから最新の比較導線をご利用ください。",
        compareCta: "比較ハブへ",
    ...
    : {
        ...
        body:
          "We are re-evaluating future-dated claims and fixed benchmark framing on this article, so it has been removed from primary entry points and indexing until editorial review is complete.",
