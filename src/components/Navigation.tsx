...
export function Navigation({ className }: { className?: string }) {
  ...
  return (
    <nav className={cn("border-b border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-black/80 backdrop-blur-md sticky top-0 z-50", className)}>
      ...
      <div
        className={cn(
          "md:hidden transition-all duration-300 ease-in-out bg-white dark:bg-black",
          isMenuOpen
            ? "max-h-[calc(100vh-4rem)] overflow-y-auto opacity-100 border-b border-zinc-200 dark:border-zinc-800"
