    ...
    <div className="mb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {promotedTools.map((tool) => (
          ...
          >
            <div className="relative h-full rounded-[23px] bg-white dark:bg-zinc-950 p-6 flex flex-col overflow-hidden">
                {/* Background Glow */}
                <div className="absolute -right-12 -top-12 h-40 w-40 rounded-full bg-amber-500/10 blur-3xl group-hover:bg-amber-500/20 transition-colors" />
