...
def run_cuj(page):
    ...
    print("Taking screenshot of compare hub CTAs...")
    # Scroll to the presets section
    page.locator("text=Quick-start comparison presets").scroll_into_view_if_needed()
    page.wait_for_timeout(1000)
    page.screenshot(path="/app/verification/screenshots/compare_hub_cta.png")

    print("Hovering over a preset CTA...")
    # Hover over the first preset CTA to trigger the group-hover
    page.locator("text=Compare this set").first.hover()
    page.wait_for_timeout(1000)
    page.screenshot(path="/app/verification/screenshots/compare_hub_cta_hover.png")

    print("Navigating to category page...")
    page.goto("http://localhost:3000/en/category/video")
    page.wait_for_timeout(2000)
